...
## 文风要求（重要）
像一个熟悉这个孩子/这个人的老师在面对面聊天，不要像报告生成器。具体来说：
- 禁用套话："需要强调的是""值得注意的是""总而言之""综上所述""这意味着""与此同时"
- 少用破折号和排比句，多用短句和口语化表达
- 不堆砌形容词（"多元而有趣""独特而丰富"这类空话一律不要）
- 每个观点落到具体行为上（"你做题时喜欢先搞懂原理"比"你具有探究精神"好）
- 允许用"挺""蛮""这块""上头"等自然口语，但不要刻意卖萌
